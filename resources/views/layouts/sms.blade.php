...
<head>
    ...
    <link href="/css/bootstrap.sms.min.css" rel="stylesheet">
    <style>
        body {
        ...
        <div class="container-narrow">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/home') }}">
                    <img src="{{ asset('/img/site-logo.png') }}" height="60" style="margin-top:-17px;">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    @else
                        <li><a href="{{ url('sms/home') }}">Dashboard</a></li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li disabled><a href="">Group SMS</a></li>
                            </ul>
                        </li>
                    @endif
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right" style="margin-right: 10px;">
                    ...
                    @if (Auth::guest())
                        <li><a href="{{ url('sms/login') }}">Login</a></li>
                    @else
                        <li class="dropdown">
